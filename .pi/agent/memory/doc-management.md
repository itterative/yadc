...
| [`tagger-architecture`](.pi/agent/memory/docs/tagger-architecture.md) | ONNX image-tagging subsystem — `Tagger` base, `TaggerResult` with categorized output, multiprocessing client/server, dataset-image API endpoint. |
