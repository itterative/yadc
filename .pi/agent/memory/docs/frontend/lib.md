...
- `frontend-patterns` — Abort contexts, SSE (TypedEventSource, Zod, resumption), Notifications
...
yadc/webui/src/lib/
  ...
  abort.ts             # Composable abort contexts for Svelte components — `createAbortContext`, `getAbortContext`, `linkedController`, `setAbortContext`
