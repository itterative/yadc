...
| [`captioning-status-bar-plan`](.pi/agent/memory/plans/captioning-status-bar-plan.md) | Refine captioning progress UI — topbar spinner + absolute progress bar, side panel Start/Stop button swap | Not started |
