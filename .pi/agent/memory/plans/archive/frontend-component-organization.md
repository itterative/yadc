...
- `+page.svelte` (routes) — Phase 2.2 partially addresses. The dead `createDatasetBrowserStore` factory was removed as a follow-up cleanup (the page reimplements the same logic inline with Svelte 5 runes).
