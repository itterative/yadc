...
# ---------------------------------------------------------------------------
# SSE connection leak test
# ---------------------------------------------------------------------------


@pytest.mark.asyncio
async def test_sse_receive_cleanup_removes_queue_on_cancel():
...
@pytest.mark.asyncio
async def test_sse_receive_cleanup_removes_queue_on_shutdown():
...
@pytest.mark.asyncio
async def test_sse_receive_events_are_delivered():
...
# ---------------------------------------------------------------------------
# EventDispatcher thread-to-async bridge test
# ---------------------------------------------------------------------------


@pytest.mark.asyncio
async def test_event_dispatcher_bridge_async_handler_from_background_thread():
...
@pytest.mark.asyncio
async def test_event_dispatcher_bridge_sync_handler_from_background_thread():
