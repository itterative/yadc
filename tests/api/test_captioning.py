...
@pytest.mark.asyncio
async def test_start_captioning_password_required(client):
    test_client, mock_service = client
    ...
    with patch("yadc.api.controllers.api_captioning.cmd_envs") as mock_cmd_envs:
        ...
        resp = await test_client.post("/api/datasets/test/caption", json={})
...
@pytest.mark.asyncio
async def test_caption_single_image_password_required(client):
    test_client, mock_service = client
    ...
    with patch("yadc.api.controllers.api_captioning.cmd_envs") as mock_cmd_envs:
        ...
        resp = await test_client.post("/api/datasets/test/images/1/caption", json={})
