...
from yadc.core.exporters import list_backends, get_backend, run_export
...
class TestExportTxt:
    def test_export_caption_source(self, tmp_images):
        ...
        count = run_export(
            'sd-scripts', images, fmt='txt', source='caption',
            draft_name='', output=out_dir, append=False, caption_extension='.caption',
        )
    ...
    def test_export_draft_source(self, tmp_images):
        ...
        count = run_export(
            'sd-scripts', images, fmt='txt', source='draft',
            draft_name='test', output=out_dir, append=False, caption_extension='.caption',
        )
    ...
    def test_export_txt_alongside_images(self, tmp_images):
        ...
        count = run_export(
            'sd-scripts', images, fmt='txt', source='caption',
            draft_name='', output=None, append=False, caption_extension='.caption',
        )
    ...
    def test_export_txt_append(self, tmp_images):
        ...
        run_export(
            'sd-scripts', images[:1], fmt='txt', source='caption',
            draft_name='', output=out_dir, append=False, caption_extension='.caption',
        )
        run_export(
            'sd-scripts', images[1:2], fmt='txt', source='caption',
            draft_name='', output=out_dir, append=True, caption_extension='.caption',
        )
...
class TestExportJson:
    def test_export_caption_source(self, tmp_images):
        ...
        count = run_export(
            'sd-scripts', images, fmt='json', source='caption',
            draft_name='', output=output, append=False, caption_extension='.caption',
        )
    ...
    def test_export_draft_source(self, tmp_images):
        ...
        count = run_export(
            'sd-scripts', images, fmt='json', source='draft',
            draft_name='test', output=output, append=False, caption_extension='.caption',
        )
    ...
    def test_export_json_append_merges(self, tmp_images):
        ...
        run_export(
            'sd-scripts', images[:1], fmt='json', source='caption',
            draft_name='', output=output, append=False, caption_extension='.caption',
        )
        count = run_export(
            'sd-scripts', images[1:2], fmt='json', source='caption',
            draft_name='', output=output, append=True, caption_extension='.caption',
        )
    ...
    def test_export_json_append_overwrites_same_key(self, tmp_images):
        ...
        run_export(
            'sd-scripts', images[:1], fmt='json', source='draft',
            draft_name='test', output=output, append=True, caption_extension='.caption',
        )
...
class TestExportJsonl:
    def test_export_caption_source(self, tmp_images):
        ...
        count = run_export(
            'sd-scripts', images, fmt='jsonl', source='caption',
            draft_name='', output=output, append=False, caption_extension='.caption',
        )
    ...
    def test_export_draft_source(self, tmp_images):
        ...
        count = run_export(
            'sd-scripts', images, fmt='jsonl', source='draft',
            draft_name='test', output=output, append=False, caption_extension='.caption',
        )
    ...
    def test_export_jsonl_append(self, tmp_images):
        ...
        run_export(
            'sd-scripts', images[:1], fmt='jsonl', source='caption',
            draft_name='', output=output, append=False, caption_extension='.caption',
        )
        count = run_export(
            'sd-scripts', images[1:2], fmt='jsonl', source='caption',
            draft_name='', output=output, append=True, caption_extension='.caption',
        )
...
class TestReadCaptionSource:
    ...
    def test_invalid_format_for_backend(self, tmp_images):
        ...
        with pytest.raises(ValueError, match='does not support format'):
            run_export(
                'sd-scripts', images, fmt='xml', source='caption',
                draft_name='', output=output, append=False, caption_extension='.caption',
            )
