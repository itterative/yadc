...
* with pipx, `pipx install git+https://github.com/itterative/yadc@0.3.0` then `yadc caption DATASET_TOML`
* with uvx, `uv tool install git+https://github.com/itterative/yadc@0.3.0` then `yadc caption DATASET_TOML`
