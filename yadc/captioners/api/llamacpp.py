"""``LlamacppCaptioner`` — llama.cpp backend (uses ``max_tokens`` instead of ``max_completion_tokens``)."""
...
class LlamacppCaptioner(OpenAICaptioner):
    def __init__(self, **kwargs: Any):
        super().__init__(api_type=APITypes.LLAMACPP, **kwargs)
