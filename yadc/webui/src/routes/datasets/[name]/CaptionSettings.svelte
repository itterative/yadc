<script lang="ts">
	...
	let reasoningEnabledOverridden = $derived(reasoningEnabled !== datasetDefaults.reasoningEnabled);
	...
	<div class="flex-1 space-y-5 overflow-y-auto p-4">
		...
		<section class="space-y-3">
			...
			<div class="flex items-end gap-2">
				...
				<div class="flex gap-2 pb-px">
					{#if isNewTemplate}
						<button class="btn-secondary px-3 py-2" onclick={cancelNewTemplate}> Cancel </button>
						<button
		...
		<section class="space-y-3">
			...
			<div class="grid grid-cols-2 gap-3">
				...
				<div>
					...
					<select id="caption-quality" class="input cursor-pointer" bind:value={imageQuality}>
		...
		<section class="space-y-3">
			<div class="flex items-center gap-2">
				...
				<label class="section-heading cursor-pointer" for="caption-reasoning"> Reasoning </label>
				{#if reasoningEnabledOverridden}
					<span class="diff-dot" title="Differs from dataset config"></span>
				{/if}
			</div>
			...
			{#if reasoningEnabled}
				<div>
					...
					<select id="caption-effort" class="input cursor-pointer" bind:value={reasoningEffort}>
						<option value="low">Low</option>
		...
		{#if overriddenCount > 0}
			<section class="overflow-hidden rounded-lg border border-border">
				...
				>
					<SvgChevronLeft
						class="h-4 w-4 transition-transform {overridesExpanded ? '-rotate-90' : '-rotate-180'}"
					/>
