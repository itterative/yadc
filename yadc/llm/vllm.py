"""``VllmLLMClient`` — vLLM backend.

vLLM's server expects ``max_tokens`` (not ``max_completion_tokens``).
...
class VllmLLMClient(OpenAICompatibleLLMClient):
    """Client for a vLLM server's OpenAI-compatible endpoint."""
