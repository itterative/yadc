...
from . import cli_cache, cli_caption, cli_configs, cli_draft, cli_envs, cli_export, cli_logging, cli_prompts, cli_tagger, cli_templates, cli_webui
...
cli.add_command(cli_tagger.tagger)
cli.add_command(cli_envs.envs)
cli.add_command(cli_configs.configs)
cli.add_command(cli_prompts.prompts)
